                ...
                <div className="p-[3rem]">
                    ...
                    <div className="grid grid-cols-12 gap-y-4">
                        ...
                        <div className="xl:col-span-12 col-span-12">
                            ...
                            <div className="input-group">
                            <input type={(passwordshow2) ? 'text' : "password"} className="form-control form-control-lg !rounded-e-none" id="reset-password" placeholder="current password"/>
                        ...
                        <div className="xl:col-span-12 col-span-12 mb-4">
                            ...
                            <div className="input-group">
                            <input type={(passwordshow3) ? 'text' : "password"} className="form-control form-control-lg !rounded-e-none" id="reset-password" placeholder="current password"/>
