                        ...
                        <div className="sm:flex align-top justify-between">
                                ...
                                <div className="sm:flex flex-wrap gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="popular-tags mb-2 sm:mb-0">
                                            <Link href="#!" className="badge  me-2 !rounded-full bg-info/10 text-info"><i className="bi bi-clock me-1"></i>Full Time</Link>
                                            <Link href="#!" className="badge !rounded-full bg-danger/10 text-danger"><i className="bi bi-briefcase me-1"></i>13 Openings</Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <div className="btn-list sm:flex items-center mb-2">
                                    <Link href="#!" className="ti-btn ti-btn-primary-full m-0 !me-[0.375rem]"> Apply Now</Link>
                                    <Link aria-label="anchor" href="#!" className="ti-btn ti-btn-icon ti-btn-primary me-[0.375rem]">
                ...
                <div className="grid grid-cols-12 gap-6">
                    <div className="xxl:col-span-8 col-span-12">
                            ...
                            <div className="box-body">
                                <div className="grid grid-cols-12 items-center">
                                    ...
                                    <div className="lg:col-span-6 col-span-12 text-end">
                                        <Link href="#!" className="ti-btn ti-btn-success-full ti-btn-lg dark:!border-defaultborder/10">
                        ...
                        <div>
                            ...
                            <Swiper slidesPerView={2} spaceBetween={30} centeredSlides={false} navigation={true} modules={[Navigation, Autoplay]} className="mySwiper" autoplay={{ delay: 2500, disableOnInteraction: false, }} >
                                    ...
                                    <div className="box custom-box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center"><Link href="#!"> HTML Developer</Link></h5>
                                                    <Link href="#!"><i className="bi bi-building"></i> Spotech Technical Solutions</Link>
                                                </div>
                                            </div>
                                            <div className="popular-tags mb-4">
                                                <Link href="#!" className="badge  me-2 !rounded-full bg-light text-default"><i className="bi bi-geo-alt text-muted me-1"></i> Hyderabad</Link>
                                                <Link href="#!" className="badge  me-2 !rounded-full bg-light text-default"><i className="bi bi-mortarboard text-muted me-1"></i> Graduate</Link>
                                                <Link href="#!" className="badge !rounded-full bg-light text-default"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                            </div>
                                            <div className="sm:flex justify-between">
                                                <h6 className="font-semibold mb-0">$25,000 - $35,000</h6>
                                                <Link href="" className="text-primary font-semibold text-[.875rem]">
                                    ...
                                    <div className="box custom-box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center"><Link href="#!"> React Developer</Link></h5>
                                                    <Link href="#!"><i className="bi bi-building"></i> Infratech PVT LTD</Link>
                                                </div>
                                            </div>
                                            <div className="popular-tags mb-4">
                                                ...
                                                <Link href="#!" className="badge !rounded-full bg-light !text-defaulttextcolor"><i className="bi bi-clock text-muted me-1"></i> Min - 2Years</Link>
                                            </div>
                                            <div className="sm:flex justify-between">
                                                <h6 className="font-semibold mb-0">$25,000 - $35,000</h6>
                                                <Link href="" className="text-primary font-semibold text-[.875rem]">
                                    ...
                                    <div className="box custom-box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center"><Link href="#!"> Vuejs Developer</Link></h5>
                                    ...
                                    <div className="box custom-box featured-jobs">
                                        <div className="box-body">
                                            ...
                                            <div className="sm:flex mb-4">
                                                ...
                                                <div className="ms-2">
                                                    <h5 className="font-semibold mb-0 flex items-center"><Link href="#!"> Wordpress Developer</Link></h5>
                    ...
                    <div className="xxl:col-span-4 col-span-12">
                        <div className="box custom-box border dark:border-defaultborder/10">
                                ...
                                <ul className="list-group  list-group-flush">
                                    <li className="list-group-item !border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link href="#!"> React Lead Developer</Link></p>
                                    ...
                                    <li className="list-group-item border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link href="#!"> HTML Developer - Fresher</Link></p>
                                    ...
                                    <li className="list-group-item border-t-0 !border-s-0 !border-e-0 mb-2">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link href="#!"> Wordpress Developer - Remote</Link></p>
                                    ...
                                    <li className="list-group-item !border-b-0 !border-s-0 !border-e-0">
                                        <div className="sm:flex">
                                            ...
                                            <div className="ms-2 flex-grow">
                                                <p className="font-semibold text-[.875rem] mb-1"><Link href="#!"> Vuejs Frontend Developer</Link></p>
                            ...
                            <div className="box-footer">
                                <Link href="#!" className="text-primary font-semibold text-[.875rem] mt-2">
                            ...
                            <div className="box-body">
                                <div className="">
                                    ...
                                    <label className="form-check-label" htmlFor="invalidCheck">
                                        By Subscribing you accept to <Link href="#!" className="text-success mx-2"><u>privacy policy</u></Link>
                                    </label>
                                </div>
                            </div>
                        </div>
...
Jobdetails.layout = "Contentlayout"
