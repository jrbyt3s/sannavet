                            ...
                            <div className="xl:col-span-8 col-span-12">
                                <div className="xxl:mt-0 mt-4">
                                    ...
                                    <p className="text-[1.125rem] mb-4">
                                        ...
                                        <span className="font-semibold text-[#8c9097] dark:text-white/50"><Link className="text-info text-[0.875rem]" href="#!">(2.4k Likes)</Link></span>
                                    </p>
                                            ...
                                            <div className="xxl:col-span-4 xl:col-span-12 lg:col-span-12 md:col-span-12 sm:col-span-12 col-span-12">
                                                ...
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-success !text-white w-[55%]" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-success !text-white w-[22%]" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-success !text-white w-[8%]" aria-valuenow="8" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-warning w-[9%]" aria-valuenow="9" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                ...
                                                <div className="flex items-center">
                                                    ...
                                                    <i className="ri-star-fill text-[0.625rem] me-1"></i>
                                                    <div className="progress progress-xs flex-grow">
                                                        <div className="progress-bar !bg-danger w-[6%]" aria-valuenow="6" aria-valuemin="0" aria-valuemax="100">
                                                        </div>
                                                    </div>
                                                    <div className="text-[#8c9097] dark:text-white/50 ms-2 text-[0.75rem]">(1)</div>
                                                </div>
...
Nftdetails.layout = "Contentlayout"
